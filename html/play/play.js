firebase.auth().onAuthStateChanged((User) => {
  if (User) {
    ...
    function checkin(){
      ...
      let check_in = {date:ckeckin_date,time:ckeckin_time};
      let check_out = {date:"",time:""};
      let questions = [];
      let tokens_used = [];
      let bonus = {questions:questions,tokens_used:tokens_used};
      let quiz = {questions:questions,tokens_used:tokens_used}; 
      let luck = {questions:questions,tokens_used:tokens_used};
      let setback = {questions:questions,tokens_used:tokens_used};
      let challange = {questions: questions,tokens_used:tokens_used};
